...
### 克隆代码
将`golang123`的代码克隆到gopath的src/github.com/shen100目录下，即`your/gopath/src/github.com/xuangua/gowxapisrv`
...
## License
[GPL](https://github.com/xuangua/gowxapisrv-api/blob/master/LICENSE "")      
